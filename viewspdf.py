...
def connect():
    ...
    sql = (' SELECT a.SlipDiv,a.OrderNumber,DATE_FORMAT(a.OrderingDate,"%Y年%m月%d日"),a.ProductName,a.OrderingCount,a.StainPartNumber,a.SupplierPerson	,a.titlediv'
           ...
           ' ,b.DetailColorNumber,b.DetailColor,b.DetailTailoring,b.DetailVolume,b.detailunitprice,b.detailsummary,DATE_FORMAT(b.AnswerDeadline,"%Y年%m月%d日")'
           ' ,e.CustomerName,e.PostCode,e.PrefecturesCode,e.Municipalities,e.Address,e.BuildingName,e.PhoneNumber,e.FaxNumber,d.first_name,d.last_name,d.email'
           ...
           ' WHERE a.SlipDiv="A" AND a.OrderNumber="3502118" AND a.OutputDiv=1 AND b.is_Deleted= 0' )
    try:
        cur.execute(sql)
...
def print_string(pdf_canvas):
    ...
    try:
        ...
        data = [
            ['品名', '番手','色番', '色名','数量','単位','単価','希望納期','回答納期','備考'],
            [dt[0][3],dt[0][4],dt[0][16],dt[0][17],dt[0][19],' ',dt[0][20],dt[0][7],dt[0][21],' '],
            [dt[1][3],dt[1][4],dt[1][16],dt[1][17],dt[1][19],' ',dt[1][20],dt[1][7],dt[1][21],' '],
            [dt[2][3],dt[2][4],dt[2][16],dt[2][17],dt[2][19],' ',dt[2][20],dt[2][7],dt[2][21],' '],
            [dt[3][3],dt[3][4],dt[3][16],dt[3][17],dt[3][19],' ',dt[3][20],dt[3][7],dt[3][21],' '],
            [dt[4][3],dt[4][4],dt[4][16],dt[4][17],dt[4][19],' ',dt[4][20],dt[4][7],dt[4][21],' '],
            [' ',' ',' ',' ',' ',' ',' ',' ',' ',' '],
            [' ',' ',' ',' ',' ',' ',' ',' ',' ',' '],
            [' ',' ',' ',' ',' ',' ',' ',' ',' ',' '],
            [' ',' ',' ',' ',' ',' ',' ',' ',' ',' '],
    ...
    table = Table(data, colWidths=(50*mm, 15*mm, 20*mm, 20*mm, 20*mm, 15*mm, 20*mm, 30*mm, 30*mm, 50*mm), rowHeights=7.5*mm)
