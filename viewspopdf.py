...
def print_string_StainRequest(pdf_canvas,dt):
    ...
    #img = './mysite/myapp/templates/image/image1.jpg'
    img = './static/image/image1.jpg'
    pdf_canvas.drawImage(img, 110*mm, 215*mm , 20*mm, 5*mm)
    ...
    font_size = 9
    pdf_canvas.setFont('HeiseiMin-W3', font_size)
    pdf_canvas.drawString(255, 460,'出荷先名')
    pdf_canvas.setFont('HeiseiMin-W3', font_size)
    ...
    table = Table(data, colWidths=(15*mm, 15*mm, 20*mm, 15*mm, 15*mm, 20*mm, 20*mm, 43*mm), rowHeights=7.5*mm)
    table.setStyle(TableStyle([
    ...
    #img = './mysite/myapp/templates/image/image2.jpg'
    img = './static/image/image2.jpg'
    pdf_canvas.drawImage(img, 65*mm, 10*mm, 38*mm, 7*mm)
